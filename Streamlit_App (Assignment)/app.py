...
APP_DESCRIPTION = (
    ...
    "powered by the lightweight `google/flan-t5-small` model from Hugging Face."
)
...
def generate_response(question: str, max_length: int, temperature: float) -> str:
    """Generate an AI response for the given question."""
    tokenizer, model = load_model()
    do_sample = temperature > 0.0
    inputs = tokenizer(question, return_tensors="pt")
    generate_kwargs = {"max_new_tokens": max_length, "do_sample": do_sample}
    if do_sample:
